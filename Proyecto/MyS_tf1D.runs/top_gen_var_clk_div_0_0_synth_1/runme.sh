...
HD_PWD='/home/hernan/MyS_tf1D/MyS_tf1D.runs/top_gen_var_clk_div_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gen_var_clk_div_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_gen_var_clk_div_0_0.tcl

...
HD_PWD='/home/hernan/MyS_tf1D/MyS_tf1D.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gen_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_gen_wrapper.tcl -notrace
